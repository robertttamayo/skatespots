        ...
        return(
            <div className="mode-add-skater">
                ...
                <form className="mode-form view-add-skater-form" onSubmit={this.submit}>
                    <input name="skater_username" type="text" placeholder="Username" 
                        value={this.state.skater_username} onChange={this.onChange} />
                    <input name="skater_password" type="text" placeholder="Password"
                    value={this.state.skater_password} onChange={this.onChange} />
                </form>
